...
for county_name in county_votes:
        ...
        percentage= int(county_votes) / int(total_votes) *100
                 # 6d: Print the county results to the terminal.
        county_results=(
        f'{county_name}:{percentage:.1f}% ({county_votes:,}\n')
        ...
        if (county_votes > largest_county_vote):
            largest_count_vote = county_votes
    ...
    # 8: Save the county with the largest turnout to a text file.
        outfile.write(largest_county_summary)
